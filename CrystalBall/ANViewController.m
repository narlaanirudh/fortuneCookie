...
- (void)viewDidLoad
{
    ...
    self.CrystalBall = [[ANCrystalBal alloc] init];
    
    self.backgroundAnimation.animationImages = [[NSArray alloc] initWithObjects:
    ...
    self.backgroundAnimation.animationDuration = 2.0f;
    self.backgroundAnimation.animationRepeatCount = 1;
...
{
    [self.backgroundAnimation startAnimating];
    self.predictionLabel.text = [self.CrystalBall randomString];
...
{
    NSLog(@"touch cancelled cancelled");
